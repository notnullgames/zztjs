...
import { ZZTFileStream } from './zztfilestream'
import { ZZTBoard } from './zztboard'

export function ZZTWorld () {}

export function ZZTWorldLoader () {
}
...
ZZTWorldLoader.prototype.parseZZTBoard = function (stream) {
  ...
  var statusElement = []
  for (var i = 0; i < statusElementCount; ++i) { statusElement.push(this.parseStatusElement(stream)) }
